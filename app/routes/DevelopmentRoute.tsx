...
import "../app-v2.css";
import FeatureSelector, { type Feature } from "~/presentation/software/FeatureSelector";
  ...
  const buttons: Feature[] = [
    {
      ...
      description: ["We charge a flat fee, not a percentage of your donations, so you keep more of the money you raise.", "Another paragraph"],
    },
    {
      className: "center col middle",
      icon: { name: "lock-closed-outline", size: 50 },
      text: "Security built for your specific use case",
      description: ["By building a custom site, we know exactly where your data is stored, and where the biggest risks are."]
    },
    {
      className: "center col middle",
      icon: { name: "sparkles-outline", size: 50 },
      text: "Your dream features",
      description: ["Instead of spending hours finding hacky work-arounds to make your cool ideas work, give them to us!"]
    },
    {
      className: "center col middle",
      icon: { name: "people-outline", size: 50 },
      text: "Face to face support",
      description: ["Our local team is here to help you, and your clients every step of the way."]
    },
     {
      className: "center col middle",
      icon: { name: "flash", size: 50 },
