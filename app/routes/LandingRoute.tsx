...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { property: "og:title", content: "Transform Creative" },
    {
    ...
    { property: "og:url", content: "https://www.transformcreative.com.au/" }, // Replace with your actual URL
